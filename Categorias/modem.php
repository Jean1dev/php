...
<div id="menuinterativo">
		<ul>
		<li><a href="eletro.php" class="menu_pri">Eletroeletronicos</a>
			<ul class="into">
			<li><a href="tablet.php">Tablets</a></li>
			<li><a href="dvd.php">Aparelhos de dvd</a></li>
			<li><a href="cel.php">Celulares</a></li>
			</ul>
		</li>
							
		<li><a href="domestico.php"  class="menu_pri">Eletrodomesticos</a>
			<ul class="into">
				<li><a href="aspirador.php">Aspirador</a></li>
				<li><a href="gelo.php">Geladeira</a></li>
				<li><a href="tv.php">Televisores</a></li>
			</ul>
		</li>
		
		<li><a href="info.php"  class="menu_pri">Informatica</a>
			<ul class="into">
				<li><a href="pc.php">Computadores</a></li>
				<li><a href="not.php">Notebooks</a></li>
				<li><a href="utpc.php">Utencilios para computador</a></li>
				<li><a href="modem.php">Modens</a></li>
			</ul>
		</li>
					
		<li><a href="ferramenta.php"  class="menu_pri">Ferramentas</a>
			<ul class="into">
				<li><a href="martelo.php">Martelos</a></li>
				<li><a href="pa.php">Pás</a></li>
				<li><a href="furao.php">Furadeiras</a></li>									
			</ul>
		</li>
